...
const LEVEL_DATA : Dictionary = {
	...
	"level_002": { "display_name": "hoppin' around",  "medal_time": 14.00 },
	"level_003": { "display_name": "collect postage",  "medal_time": 10.50 },
	"level_004": { "display_name": "the wave",  "medal_time": 16.00 },
	...
	"level_008": { "display_name": "boomerang",  "medal_time": 11.0 },
	"level_009": { "display_name": "Level 9",  "medal_time": 17.00 },
	"level_010": { "display_name": "chain dash", "medal_time": 20.0 },

	"level_011": { "display_name": "Level 11", "medal_time": 14.50 },
	...
	"level_018": { "display_name": "like magic", "medal_time": 13.00},
	"level_019": { "display_name": "Level 19", "medal_time": 19.50 },
	"level_020": { "display_name": "steady", "medal_time": 22.0 }
}
