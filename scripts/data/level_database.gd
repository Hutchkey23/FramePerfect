...
const LEVEL_DATA : Dictionary = {
	"level_001": { "display_name": "it begins",  "medal_time": 1.50 },

	"level_002": { "display_name": "beware the red squares",  "medal_time": 1.50 },
	"level_003": { "display_name": "hoppin' around",  "medal_time": 2.00 },
	"level_004": { "display_name": "collect postage",  "medal_time": 3.00 },
	"level_005": { "display_name": "the wave",  "medal_time": 2.50 },
	"level_006": { "display_name": "fetch quest",  "medal_time": 4.00 },

	"level_007": { "display_name": "?",  "medal_time": 4.00 },
	"level_008": { "display_name": "Level 8",  "medal_time": 14.00 },
	"level_009": { "display_name": "Level 9",  "medal_time": 16.00 },
	"level_010": { "display_name": "chain dash", "medal_time": 3.00 },
	"level_011": { "display_name": "Level 10", "medal_time": 13.00 },
	...
	"level_018": { "display_name": "Level 18", "medal_time": 17.50 },
	"level_019": { "display_name": "thread the needle", "medal_time": 5.00 },
	"level_020": { "display_name": "boomerang",  "medal_time": 6.00 },
	"level_021": { "display_name": "steady", "medal_time": 7.00 }
}
